...
const notaMinia = parseFloat(prompt("digite a nota mínima:"));
...
function adicionaLinha() { 
    ...
    if (atividades.includes(inputNomeAtividade.value)) {
        ...
        linha += `<td> ${inputNotaAtividade.value >= notaMinia ? imgAprovado : imgReprovado}</td>`;
        linha += `</tr>`;
...
function atualizaMediaFinal() {
    ...
    document.getElementById('aprovOUreprov').innerHTML = mediaFinal >= notaMinia ? spanAprovado : spanReprovado;
}
